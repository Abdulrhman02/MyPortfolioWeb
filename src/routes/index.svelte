...
<div class=" test">
	...
	<span class="content v2"><p>Vanilla (HTML/CSS)</p></span>
	<span class="content v2"><p>Woah</p></span>
</div>
<div class=" test">
...
<style>
	* {
	...
	.container .box:nth-child(1):after {
		background: linear-gradient(315deg, #4bd8a2, #7f3fac);
	}
	...
	.v2 p {
		...
		border-radius: 8px;
		padding: 5px 15px;
		background-image: linear-gradient(315deg, rgba(75, 216, 162, 0.2), rgba(127, 63, 172, 0.2));
	}
	.v2:hover p {
